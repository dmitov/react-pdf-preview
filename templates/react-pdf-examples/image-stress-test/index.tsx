import { Document, Page, Image, DocumentProps } from "@react-pdf/renderer";
...
export default function ImageStressTest(props: DocumentProps) {
  return (
    <Document {...props} title="Image Stress Test">
