...
export default function FontFamilyFallback(props: DocumentProps) {
  return (
    <Document {...props} title="Font Family Fallback">
      <Page style={styles.body}>
        ...
        <Text style={{ fontSize: 10 }}>
          The following are multiple font families, weights, and styles all on
          the same line
        </Text>
